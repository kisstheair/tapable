...
class HookCodeFactory {
	...
	create(options) {
		...
		switch(this.options.type) {
			case "sync":
				...
				const BBB = this.args()+ "\"use strict\";\n" + this.header() + this.content({
	...
	setup(instance, options) {
		instance._x = options.taps.map(t => t.fn);             // 所有fn 的一个数组。[fn,fn,fn,,,,,]
	}
	...
	args({ before, after } = {}) {                         // before, after  表示是否在前面  或者后面添加参数
